...
from scraper import get_external_links, get_internal_links
...
def test_get_external_links():
    ...
    assert links == ['tcgdatabase.fr', 'finalyugi.com', 'cartabella.fr', 'pikalab.com', 'playfactory.fr',
                    'ultrajeux.com', 'designertoyz.com', 'kokeshi.fr', 'mibbit.com', 'mogg.fr', 'xiti.com']
...
def test_get_internal_links():
    ...
    assert links == {'www.cybelangel.com/#contact',
                     'www.cybelangel.com/detection-of-counterfeiting',
